...
<section id="list" class="list">
    ...
    <select name="categoryid" class="form-select" aria-label="Select Category_id" required>
    ...
    <select name="allergenid" class="form-select" aria-label="Select Allergen" required>
...
<div class="input-group mb-3">
  ...
  <input type="text" name="description" class="form-control" aria-label="Year" aria-describedby="inputGroup-sizing-default">
</div>
<div class="input-group mb-3">
