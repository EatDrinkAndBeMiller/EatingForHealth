  ...
  <div class="row">
    ...
    <div class="col-2">
      ...
      <ul class="text-left">
        <li>Monk Fruit</li>
        <li>Swerve</li>
        <a href=".?action=sub-sweeteners">Read More...</a>
      </ul>
    </div>
  </div>
<hr>
  ...
  <div class="row">
    ...
    <div class="col-3">
      ...
      <ul class="text-left">
        <li>Banana</li>
        <li>Yogurt</li>
        <a href="index.php?action=sub-eggs">Read More...</a><br>
      </ul>
    </div>
  </div>
<hr>
  ...
  <div class="row">
    ...
    <div class="col-5">
      <p class="text-left">Dairy Replacements</p>
      <ul class="text-left">
      ...
      <p>*Read Ingredient Labels before purchasing</p>
    </div>
  </div>
<br>
